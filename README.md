# Artin Holomorphy Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/artin-holomorphy-conjecture-canonical-lane-mathlib.git
cd artin-holomorphy-conjecture-canonical-lane-mathlib
lake exe
lake build
```
